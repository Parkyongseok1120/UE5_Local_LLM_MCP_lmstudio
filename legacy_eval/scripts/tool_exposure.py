#!/usr/bin/env python
"""Legacy Strict RAG tool exposure policy.

Direct mode does not import or consult this policy.  Its catalog is derived
from the registered capabilities by :mod:`direct_model_mode`.
"""
...
MANIFEST_PATH = ROOT / "legacy_eval" / "config" / "python_workflow_tool_manifest.json"
