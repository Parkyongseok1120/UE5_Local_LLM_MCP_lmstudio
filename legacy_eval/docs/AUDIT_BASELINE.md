# Historical Phase 0 — Pre-Improvement Audit Baseline

> **ARCHIVED BASELINE.** This captures the repository before Direct Model Mode.
> File names, command routes, and controller ownership below are historical and
> must not be used as current MCP setup or runtime guidance.
