...
> **ARCHIVED BASELINE.** This pre-Direct inventory is retained only for change
> history. Current setup and runtime authority are documented in
> `LMStudio_Unreal_Agent_Setup.md` and `ARCHITECTURE.md`.
