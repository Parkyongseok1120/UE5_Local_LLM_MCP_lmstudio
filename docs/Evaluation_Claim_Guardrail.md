...
The current product is **1.3.0 RC1**, but it has no new paired live-model score yet. Do not attribute the v1.2.5 measurements below to RC1 architecture or orchestration changes.
