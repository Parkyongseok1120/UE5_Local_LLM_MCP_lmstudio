...
| 구성 | 현재 표시 | 기준 파일 |
|---|---|---|
| 제품 | 1.4.0 beta 4 | [installer/manifest.json](../installer/manifest.json) |
...
| 대화 압축기 | 0.4.70 / revision 117 | [package.json](../lmstudio-context-compactor-plugin/package.json), [manifest.json](../lmstudio-context-compactor-plugin/manifest.json) |
| 압축 배포 구성 | 2.1.22 | [installer/manifest.json](../installer/manifest.json) |
...
`portablePackage.releaseReady`는 자동 검사와 배포 준비 상태에 쓰는 값입니다. 모든 장비·엔진·프로젝트에서 실제 실행을 보장한다는 뜻은 아닙니다. 최신 변경 내용은 [1.4.0 beta 4 변경 사항](Release_Notes_1_4_0_beta4.md)에 있습니다.
