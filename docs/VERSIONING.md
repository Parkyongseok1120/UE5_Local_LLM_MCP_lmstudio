...
| 대화 압축기 | 0.4.61 / revision 108 | [package.json](../lmstudio-context-compactor-plugin/package.json), [manifest.json](../lmstudio-context-compactor-plugin/manifest.json) |
| 압축 배포 구성 | 2.1.21 | [installer/manifest.json](../installer/manifest.json) |
