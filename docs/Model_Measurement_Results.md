...
- Qwen 3.6 27B is the primary measured profile for unattended live compile-fix validation.
...
- Qwen 3.6 27B는 현재 unattended live compile-fix 검증의 주 측정 profile입니다.
