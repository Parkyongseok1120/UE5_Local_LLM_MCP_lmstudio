...
CLI_PATH_FILES = (
    ...
    "scripts/collect_failure_memory.py",
    ...
    "scripts/eval_soulslike_live.py",
    "scripts/evaluate_rag_queries.py",
    ...
    "scripts/review_claim_validate.py",
    "scripts/run_phase3_finish.ps1",
    "scripts/run_ubt_feedback_loop.ps1",
    "scripts/unreal_agent_session.py",
    "scripts/validate_index.py",
    "scripts/validate_project_sources.py",
    "scripts/verify_release.py",
    "scripts/warm_symbol_cache.py",
    "rag.ps1",
)
...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("query_rag", ["What is an actor?"], "index", "rag.sqlite"),
    ),
)
