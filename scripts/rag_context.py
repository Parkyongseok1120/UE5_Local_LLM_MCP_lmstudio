...
MODE_BUCKETS = {
    ...
    "compile_fix": [
        ...
        ("project_examples", "6. Local/generic examples (reference only; do not copy symbol names)"),
    ...
    "module_fix": [
        ...
        ("module_evidence", "3. Module / Build.cs evidence"),
        ("project_profile", "4. Project profile"),
        ("project_examples", "5. Local/generic examples (reference only; do not copy symbol names)"),
