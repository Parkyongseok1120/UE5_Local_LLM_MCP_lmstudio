...
KIND_ASSET_TYPES = {
    ...
    "structured": {
        "DataTable", "DataAsset", "PrimaryDataAsset", "CurveFloat", "CurveVector", "CurveLinearColor",
        "CurveTable", "StringTable", "DataRegistry", "UserDefinedEnum", "NiagaraSystem", "NiagaraEmitter",
        "NiagaraParameterCollection", "NiagaraScript", "ParticleSystem", "BehaviorTree", "BlackboardData",
        "EnvQuery", "SmartObjectDefinition", "NavModifierVolume", "SoundCue", "SoundWave", "MetaSoundSource",
        "MetaSoundPatch", "SoundClass", "SoundMix", "SoundAttenuation", "InputAction", "InputMappingContext",
        "InputModifier", "InputTrigger", "PhysicalMaterial", "GameplayAbility", "GameplayEffect",
        "GameplayCueNotify_Static", "Font", "FontFace", "MediaPlayer", "FileMediaSource", "ImgMediaSource",
    },
    "texture": {"Texture2D", "TextureCube", "TextureRenderTarget", "TextureRenderTarget2D", "MediaTexture", "RuntimeVirtualTexture"},
    "mesh": {"StaticMesh", "GeometryCollection", "FoliageType_InstancedStaticMesh"},
    "world_look": {"PostProcessVolume", "SkyAtmosphere", "ExponentialHeightFog", "VolumetricCloud", "DataLayerAsset"},
    "fmod": {"FMODEvent", "FMODBank", "FMODBankLookup", "FMODAsset"},
    "animation": {
        "SkeletalMesh", "AnimBlueprint", "AnimSequence", "AnimMontage", "AnimNotify", "AnimNotifyState",
        "LevelSequence", "PoseAsset", "BlendSpace", "BlendSpace1D", "AimOffsetBlendSpace", "Skeleton",
        "PhysicsAsset", "ControlRigBlueprint", "IKRigDefinition", "IKRetargeter",
    },
